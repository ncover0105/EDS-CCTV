        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-6 col-11 text-center" >
                    <span style="font-size: 3.5rem; font-weight: bold;" onclick="toggleFullScreen()"><img id="mainLogo" src="/css/edslogo.png" style="height: 4.5rem; margin-top: -10px;" alt="로고"> 기상종합상황판</span>
                </div>
...
<script>
    ...
    const colWayIconArray={'1':'/css/edsicon.png','2':'/css/edsicon.png','3':'/css/edsicon.png','4':'/css/edsicon.png','5':'/css/csicon.ico','6':'/css/gumiicon.png'};
    const colWayLogoArray={'1':'/css/edslogo.png','2':'/css/edslogo.png','3':'/css/edsLogo.png','4':'/css/edslogo.png','5':'/css/cslogo.png','6':'/css/gumilogo.png'};
    ...
    async function createEl(param)
    {
        ...
        if(param12)
        {
            el=`<div class="data-box-cmm box-wl-01-02 rain-all"><div class="tit-set"><h3 class="fontDefalt m-0 p-0" style="color: #141414;">`+param.name+`</h3><div class="last-upate mb08"><span class="date">`+param.pastDate+`</span></div></div><div class="value_boxes"><div class="value-box2"><h5 style="font-size: 14px !important;  font-weight: 600;">1h</h5><span class="value-set"><span class="value-bs">`+param.r_abs_hour+`</span><span class="unit">mm</span></span></div><div class="value-box2" style="position: relative;"><h5 style="font-size: 13px; font-weight: 600; margin-top: -3px;">일강우</h5><span style="position: absolute; bottom: 3px; font-size: 9px;">(0 - 24시)</span><span class="value-set"><span class="value-bs">`+param.r_abs_today+`</span><span class="unit">mm</span></span></div></div><div class="tit-set"><div>[mm/1hr]</div><div class="last-upate-pre"><span id="" class="date">강우 기준</span></div></div><div class="value_boxes"><div class="value-box2"><h5 style="font-size: 14px; font-weight: 600;">어제</h5><span class="value-set"><span class="value-bs">`+param.r_abs_yesterday+`</span><span class="unit">mm</span></span></div><div class="value-box2" style="position: relative;"><h5 style="font-size: 13px; font-weight: 600; margin-top: -3px;">연강우</h5><span style="position: absolute; bottom: 3px; font-size: 9px;">(1년)</span><span class="value-set"><span class="value-bs">`+param.r_abs_year+`</span><span class="unit">mm</span></span></div></div></div>`
        }
        else
        {
            el=`<div class="data-box-cmm box-wl-01-02 rain"><div class="tit-set"><h3 class="fontDefalt m-0 p-0" style="color: #141414;">`+param.name+`</h3><div class="last-upate mb08"><span class="date">`+param.pastDate+`</span></div></div><div class="value_boxes"><div class="value-box2"><h5 style="font-size: 14px !important;  font-weight: 600;">1h</h5><span class="value-set"><span class="value-bs">`+param.r_abs_hour+`</span><span class="unit">mm</span></span></div><div class="value-box2" style="position: relative;"><h5 style="font-size: 13px; font-weight: 600; margin-top: -3px;">일강우</h5><span style="position: absolute; bottom: 3px; font-size: 9px;">(0 - 24시)</span><span class="value-set"><span class="value-bs">`+param.r_abs_today+`</span><span class="unit">mm</span></span></div></div><div class="tit-set"><div>[mm/1hr]</div><div class="last-upate-pre"><span id="" class="date">강우 기준</span></div></div><div class="value_boxes"><div class="value-box2"><h5 style="font-size: 14px; font-weight: 600;">어제</h5><span class="value-set"><span class="value-bs">`+param.r_abs_yesterday+`</span><span class="unit">mm</span></span></div><div class="value-box2" style="position: relative;"><h5 style="font-size: 13px; font-weight: 600; margin-top: -3px;">연강우</h5><span style="position: absolute; bottom: 3px; font-size: 9px;">(1년)</span><span class="value-set"><span class="value-bs">`+param.r_abs_year+`</span><span class="unit">mm</span></span></div></div></div>`
        }
        return el;
    }
