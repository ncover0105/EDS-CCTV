...
<html>
<head>
    <title id="mainTitle">봉화군</title>
    <link rel="icon" id="mainIcon" type="image/png" href="/css/bhicon.png">
    ...
    <link rel="stylesheet" href="/css/rain_grid_bh.css">
    <!-- fontNoto -->
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                        ...
                        <li><a class="dropdown-item" href="/rain"><i class="fa-solid fa-table-columns"></i> 봉화군</a>
                        </li>
                        <li>
                ...
                <div class="row w-100">
                    ...
                    <div class="col-xl-6 col-11 text-center">
                        <span style="font-size: 3.5rem; font-weight: bold;" onclick="toggleFullScreen()"><img
                                id="mainLogo" src="/css/bhlogo.png" style="height: 4.5rem; margin-top: -10px;"
                                alt="로고"> 봉화군 강우상황판</span>
                    </div>
                ...
                <div class="col-xl-9 col-12">
                    <div class="row">
                        <div class="col-xl-6 col-12">
                            <div class="card">
                                <div style="height: 611px;" id="rainGrid">
                                    <!-- 그리드 영역 -->
                                    <!-- 시트가 될 DIV 객체 -->
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="card">
                                <div style="height: 611px;" id="rainGrid2">
                                    <!-- 그리드 영역 -->
                                    <!-- 시트가 될 DIV 객체 -->
                                    <div id="rainGrid2DIV" style="height: 100%; border-radius: 1rem; overflow: hidden;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row info" id="innerDom">
                        <div style="width:30%;height:100%; display: none">
                        ...
                        <div class="card p-0" style="width: calc(100% - 0.5rem); text-align: center;height: 100%;    margin-bottom: 0 !important;">
                            ...
                            <div class="card-body p-2" style="width: 100%;">
                                <div class="row" style="padding: 0 2rem;">
                                    <div class="col-lg-12 text-left border-bottom" style="padding-bottom: 10px">
...
<%--                                    <div class="col-lg-4 text-left border-bottom" style="padding-bottom: 7.5px">--%>
<%--                                        <span class="info-box-icon"><i class="fa-solid fa-temperature-high"></i>&nbsp&nbsp현재 온도&nbsp&nbsp:&nbsp&nbsp<strong id='TA' style="">0</strong><span class="text-sm">°C</span></span>--%>
<%--                                    </div>--%>
<%--                                    <div class="col-lg-4 text-left border-bottom" style="padding-bottom: 7.5px">--%>
<%--                                        <span class="info-box-icon"><i class="fa-solid fa-droplet"></i>&nbsp&nbsp현재 습도&nbsp&nbsp:&nbsp&nbsp<strong id='HM' style="">0</strong><span class="text-sm">%</span></span>--%>
...
<%--                                    </div>--%>
                                    <div class="wi-icons wi-icons-new w-100" style="font-size: 1rem;">
                                        <div class="wi-icon"><div class="icontime" id="objTime0">06:00</div><div style="height: 60px;"><img id="forecast0" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px; align-content: center" id="sky0">맑은날씨</div><div id="tmp0">1도</div></div>
                                        <div class="wi-icon"><div class="icontime" id="objTime1">09:00</div><div style="height: 60px;"><img id="forecast1" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky1">맑은날씨</div><div id="tmp1">1도</div></div>
                                        <div class="wi-icon"><div class="icontime" id="objTime2">12:00</div><div style="height: 60px;"><img id="forecast2" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky2">맑은날씨</div><div id="tmp2">1도</div></div>
                                        <div class="wi-icon"><div class="icontime" id="objTime3">15:00</div><div style="height: 60px;"><img id="forecast3" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky3">맑은날씨</div><div id="tmp3">1도</div></div>
                                        <div class="wi-icon"><div class="icontime" id="objTime4">18:00</div><div style="height: 60px;"><img id="forecast4" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky4">맑은날씨</div><div id="tmp4">1도</div></div>
                                        <div class="wi-icon"><div class="icontime" id="objTime5">21:00</div><div style="height: 60px;"><img id="forecast5" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky5">맑은날씨</div><div id="tmp5">1도</div></div>
                                        <div class="wi-icon"><div class="icontime" id="objTime6">00:00</div><div style="height: 60px;"><img id="forecast6" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky6">맑은날씨</div><div id="tmp6">1도</div></div>
                                        <div class="wi-icon">             <div class="icontime" id="objTime7">03:00</div><div style="height: 60px;"><img id="forecast7" src="/css/weather-icons-dev/production/fill/svg/clear-day.svg" alt=""></div><div style="height: 48px;align-content: center" id="sky7">맑은날씨</div><div id="tmp7">1도</div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    async function loadData()
    {
        rainGrid = new tui.Grid({
            ...
            summary: {
                ...
                columnContent: {
                    name: { template: function(valueMap) { return "<div class='text-center' style='word-spacing:0.8rem'>평 균</div>"}},
        ...
        rainGrid.setColumns([
            ...
            { header:'시 간 대',			name:'rainMaxTime',		minWidth:60,	align:'right',	defaultValue: 0,formatter: function (value){return value.value?value.value+"시":"0시";},hidden:true},
            { header:'시 우 량',		    name:'rainMax',		minWidth:60,	align:'right',	defaultValue: 0,hidden:true},
            // hidden(숨김)
        ]);
        rainGrid2 = new tui.Grid({
            el: document.getElementById('rainGrid2DIV'),
            scrollX: false,
            scrollY: false,
            editingEvent: 'click',
            bodyHeight: 'fitToParent',
    ...
    async function selectDevice() {
        ...
        // rainDevice의 길이에 따라 데이터 분리
        if (rainDevice.length > 10) {
            let firstTen = rainDevice.slice(0, 10); // 첫 10개
            let remaining = rainDevice.slice(10);   // 나머지 데이터

            rainGrid.resetData(firstTen); // 첫 10개는 rainGrid에
            rainGrid2.resetData(remaining); // 나머지는 rainGrid2에
        } else {
            rainGrid.resetData(rainDevice); // 10개 이하이면 rainGrid에만 설정
        }
        return rainDevice;
    }
    ...
    async function selectRainData() {
        ...
        let gridData2 = rainGrid2.getData();
        let maxValue = 0;
        let minValue = 0;
        let maxTimeValue = 0;
        let minTimeValue = 0;
        ...
        for (const datas of rainData) {
            const r_abs_today = Number(datas.r_abs_today); // r_abs_today를 숫자로 변환

            if (r_abs_today > maxValue) maxValue = r_abs_today; // 최대값 갱신
            if (r_abs_today < minValue) minValue = r_abs_today; // 최소값 갱신
        }
        for(const gridRow of gridData)
        {
            ...
            for(const datas of rainData)
            {
                if(datas.uid==gridRow.uid)
                {
                    ...
                    rainGrid.setValue(rowKey,'r_abs_today',maxminValue(rainGrid,rowKey,datas.r_abs_today,maxValue,minValue));
        ...
        for(const gridRow of gridData2)
        {
            let rowKey= gridRow.rowKey;
            for(const datas of rainData)
            {
                if(datas.uid==gridRow.uid)
                {
                    rainGrid2.setValue(rowKey,'r_abs_hour',(datas.r_abs_hour));
                    rainGrid2.setValue(rowKey,'r_abs_today',maxminValue(rainGrid2,rowKey,datas.r_abs_today,maxValue,minValue));
                    rainGrid2.setValue(rowKey,'r_abs_yesterday',(datas.r_abs_yesterday));
                    rainGrid2.setValue(rowKey,'r_abs_year',(datas.r_abs_year));
                    rainGrid2.setValue(rowKey,'r_abs_month',(datas.r_abs_month));
                }
    ...
    async function selectWaterLvData() {
        ...
        for(const waterLv of waterLvData)
        {
            ...
            if(waterLv.name==='신성교')
            {
                ...
                swHourElement.innerHTML=Number(waterLv.waterLv)*100;
                swDateElement.innerHTML=date;

            }
        }
    }
    function maxminValue(grid,rowKey,value,maxValue,minValue) {
        let returnValue='';
        grid.removeCellClassName(rowKey , 'r_abs_today' , 'red')
        grid.removeCellClassName(rowKey , 'r_abs_today' , 'blue' );
        if(maxValue==0 && minValue==0)
        {
            return (value);
        }
        if(value==maxValue) {
            grid.addCellClassName(rowKey, 'r_abs_today', 'red');
        }
        else if(Number(value)==Number(minValue))
            grid.addCellClassName( rowKey , 'r_abs_today' , 'blue' );
    ...
    function CrawlerReq()
    {
        ...
        const formattedNowDate = (currentMonth < 10 ? '0' + currentMonth : currentMonth) + '-' + (currentDay < 10 ? '0' + currentDay : currentDay) + ' ' + (currentDate.getHours() < 10 ? '0' + currentDate.getHours() : currentDate.getHours()) + ':' + (currentDate.getMinutes() < 10 ? '0' + currentDate.getMinutes() : currentDate.getMinutes()+":00");
        $.ajax({
            method:"POST",
            url:'/crawl',
            type: "POST",
                ...
                result.forEach(item => {
                    ...
                    if (element) {
                        ...
                        if (item[formattedCurrentDate]) {
                            const swTodayElement = element.querySelector('[name="swToday"]');
