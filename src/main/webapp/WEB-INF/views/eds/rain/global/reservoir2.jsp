...
<script>
    ...
    async function initMap() {
        ...
        var markersData = [
            ...
            { position: { lat: 36.3011, lng: 128.324579 }, name: '2', info: 'Information 2', radius: '1km', color: '#ffc107' },
            { position: { lat: 36.3150, lng: 128.334579 }, name: '3', info: 'Information 3', radius: '750m', color: '#007bff' }
            // 필요한 만큼 더 추가
        ];
