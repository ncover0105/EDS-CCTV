...
import com.edscorp.eds.speaker.secondary.typeb.domain.SpkAlertDispatch;
import com.edscorp.eds.speaker.secondary.typeb.domain.SpkAlertHistory;
import com.edscorp.eds.speaker.secondary.typeb.domain.SpkStatus;
import com.edscorp.eds.speaker.secondary.typeb.dto.SpkAlertDispatchRequest;
import com.edscorp.eds.speaker.secondary.typeb.dto.SpkStatusResponse;
import com.edscorp.eds.speaker.secondary.typeb.repository.SpkAlertDispatchRepository;
import com.edscorp.eds.speaker.secondary.typeb.repository.SpkAlertHistoryRepository;
import com.edscorp.eds.speaker.secondary.typeb.repository.SpkStatusRepository;
...
public class BTypeSpkService {
    ...
    public SpkStatusResponse getBtypeSpkStauts(Integer speakerKey) {
        ...
        return SpkStatusResponse.builder()
                .connectionStatus(connectionStatus)
                .acStatus(acStatus)
                .dcStatus(dcStatus)
                .batteryStatus(batteryStatus)
                .solarChargerStatus(solarStatus)
                .lteAntennaStatus(lteStatus)
