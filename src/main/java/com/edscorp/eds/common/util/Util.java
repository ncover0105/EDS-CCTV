...
public class Util {
    ...
    /**
     * <p>
     * 문자열 내부의 콜론 character(:)를 모두 제거한다.
     * </p>
     *
     * <pre>
    ...
    /**
     * <p>
     * 숫자 형식의 문자열 내부에 콤마 character(,)를 추가한다.
     * </p>
     *
     * <pre>
    ...
    /**
     * Mqtt로 받은 Date 타입 "yyyy-MM-dd HH:mm:ss" 형식 변한
     * 
     * @param receptionDttmStr
     * @return Date
     */
    public static String parseReceptionDttm(String receptionDttmStr) {
        try {
            SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy_MM_dd-HH:mm:ss");
            SimpleDateFormat outputFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

            Date parsedDate = inputFormat.parse(receptionDttmStr);
    ...
    public static Date parseDttm(String dateString) {
        try {
            SimpleDateFormat outputFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static String getRoundedHour() {
